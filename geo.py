...
# no problem at reading files but need to expand 
# space to search for all nearest neighbours
...
b=cell_expd_cart(a[0],a[1],a[2],pm)
c=mv_atom_center(b[0],b[1],b[2],3)
#lst1=nb_lst(b[0],c,b[2],1,6.5)
#print lst1
op.get_xsf_cart_in(b[0],c,b[2],'tmp.xsf')
